  ...
  return (
    <div className="space-y-4 md:space-y-6 pb-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl md:text-3xl font-bold">Assign Judges</h1>
        ...
        <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gray-100 flex items-center justify-center">
          <UserCog className="h-5 w-5 md:h-6 md:w-6 text-gray-700" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2 md:gap-4">
        <Card className="border shadow-sm">
          <CardContent className="p-3 md:p-4 text-center">
            <div className="w-8 h-8 md:w-12 md:h-12 mx-auto mb-1 md:mb-2 rounded-lg bg-gray-100 flex items-center justify-center">
              <Calendar className="h-4 w-4 md:h-6 md:w-6 text-gray-700" />
            </div>
            <p className="text-lg md:text-2xl font-bold">{events?.length || 0}</p>
        ...
        <Card className="border shadow-sm">
          <CardContent className="p-3 md:p-4 text-center">
            <div className="w-8 h-8 md:w-12 md:h-12 mx-auto mb-1 md:mb-2 rounded-lg bg-gray-100 flex items-center justify-center">
              <Users className="h-4 w-4 md:h-6 md:w-6 text-gray-700" />
            </div>
            <p className="text-lg md:text-2xl font-bold">{teams?.length || 0}</p>
        ...
        <Card className="border shadow-sm">
          <CardContent className="p-3 md:p-4 text-center">
            <div className="w-8 h-8 md:w-12 md:h-12 mx-auto mb-1 md:mb-2 rounded-lg bg-gray-100 flex items-center justify-center">
              <UserCog className="h-4 w-4 md:h-6 md:w-6 text-gray-700" />
            </div>
            <p className="text-lg md:text-2xl font-bold">{events?.filter((e: any) => e.status === 'active').length || 0}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
        {events?.map((event: any) => {
          ...
          return (
            <Card key={event.id} className="border-2 hover:border-gray-400 hover:shadow-lg transition-all">
                ...
                <div className="space-y-3 md:space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 md:gap-3">
                    <div className="flex items-center gap-1.5 md:gap-2 text-sm">
                      <Calendar className="h-3.5 w-3.5 md:h-4 md:w-4 text-gray-600 flex-shrink-0" />
                      <span className="text-gray-700 text-[10px] md:text-xs truncate">{new Date(event.event_date).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}</span>
                    </div>
                    <div className="flex items-center gap-1.5 md:gap-2 text-sm">
                      <Users className="h-3.5 w-3.5 md:h-4 md:w-4 text-gray-600 flex-shrink-0" />
                      <span className="text-gray-700 text-[10px] md:text-xs">{stats.totalTeams} teams</span>
                    </div>
                    <div className="flex items-center gap-1.5 md:gap-2 text-sm">
                      <Trophy className="h-3.5 w-3.5 md:h-4 md:w-4 text-gray-600 flex-shrink-0" />
                      <span className="text-gray-700 text-[10px] md:text-xs">Avg: {stats.avgScore}</span>
                    </div>
                    <div className="flex items-center gap-1.5 md:gap-2 text-sm">
                      <UserCog className="h-3.5 w-3.5 md:h-4 md:w-4 text-gray-600 flex-shrink-0" />
                      <span className="text-gray-700 text-[10px] md:text-xs">{stats.judgesAssigned} judges</span>
                    </div>
                  </div>
                  ...
                  <Button 
                    ...
                    className="bg-gray-900 hover:bg-gray-800 w-full text-sm md:text-base h-9 md:h-10"
                  >
                    Assign Judges
